// tests/components/character/SizeCard.test.ts
import { describe, it, expect } from 'vitest'
import { mountSuspended } from '@nuxt/test-utils/runtime'
import SizeCard from '~/components/character/SizeCard.vue'
...
describe('SizeCard', () => {
  ...
  describe('icon display', () => {
    ...
    it('renders icon for both Small and Medium sizes', async () => {
      const smallWrapper = await mountSuspended(SizeCard, {
        props: { size: mockSmallSize, selected: false }
      })
      const mediumWrapper = await mountSuspended(SizeCard, {
        props: { size: mockMediumSize, selected: false }
      })
