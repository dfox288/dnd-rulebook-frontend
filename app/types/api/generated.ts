 ...
 * Generated at: 2025-12-04T21:24:29.678Z
 *
...
export interface paths {
    ...
    "/v1/characters/{character}/death-save": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["characters.death-save.store"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/characters/{character}/stabilize": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["characters.stabilize"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/characters/{character}/languages/populate": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Auto-populates fixed languages based on character's selections.
         ...
         *     **Note:** This endpoint is idempotent - calling it multiple times will not create duplicates.
         */
        post: operations["characters.languages.populate"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/characters/{character}/notes": {
         ...
         * @description Returns notes organized by category: personality_trait, ideal, bond, flaw, backstory, custom.
         *
         *     **Examples:**
         *     ```
    ...
    "/v1/characters/{character}/optional-features": {
         ...
         * @description Returns invocations, maneuvers, metamagic, fighting styles, etc. that
         ...
         *     ```
         */
        post: operations["characters.optional-features.store"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/characters/{character}/available-optional-features": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         *     ```
         */
        get: operations["characters.optional-features.available"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/characters/{character}/optional-feature-choices": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         *     ```
         */
        get: operations["characters.optional-features.choices"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/characters/{character}/optional-features/{optionalFeatureId}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Used for retraining features (allowed by some class rules).
         *
         *     **Examples:**
         *     ```
         ...
         *     ```
         */
        delete: operations["characters.optional-features.destroy"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/characters/{character}/spell-slots/tracked": {
         ...
         * @description Returns spell slots grouped by type (standard and pact_magic), with each
...
export interface components {
    schemas: {
        ...
        CharacterResource: {
            ...
            /**
             * @description Primary class (for backwards compatibility - deprecated, use 'classes' array instead)
            ...
            /** @description Optional feature selections (invocations, maneuvers, metamagic, etc.) */
            optional_features?: {
                id: string;
                name: string;
                slug: string;
                feature_type: string;
                level_acquired: string;
                class_name: string;
        ...
        /** StoreCharacterOptionalFeatureRequest */
        StoreCharacterOptionalFeatureRequest: {
...
export interface operations {
    ...
    "characters.optional-features.store": {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["StoreCharacterOptionalFeatureRequest"];
            };
        };
        responses: {
            /** @description `CharacterOptionalFeatureResource` */
            201: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    "characters.optional-features.available": {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    "characters.optional-features.choices": {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    "characters.optional-features.destroy": {
        parameters: {
            query?: never;
            header?: never;
            path: {
